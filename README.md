...
- Ensured correct UI render with inline snapshot tests from React Testing Library and mocked fetch requests with Jest to eliminate API calls to the server during testing
